        ...
        protected override void Up (MigrationBuilder migrationBuilder) {
            ...
            migrationBuilder.CreateTable (
                ...
                constraints : table => {
                    ...
                    table.ForeignKey (
                        name: "FK_CourseAssignment_OfficeAssignment_InstructorID",
            ...
            migrationBuilder.CreateTable (
                ...
                constraints : table => {
                    ...
                    table.ForeignKey (
                        name: "FK_Department_OfficeAssignment_InstructorID",
                        column : x => x.InstructorID,
                        principalTable: "OfficeAssignment",
                        principalColumn: "ID",
            ...
            migrationBuilder.CreateTable (
                ...
                constraints : table => {
                    ...
                    table.ForeignKey (
                        name: "FK_OfficeAssignments_OfficeAssignment_InstructorID",
                        column : x => x.InstructorID,
                        principalTable: "OfficeAssignment",
                        principalColumn: "ID",
                        onDelete : ReferentialAction.Cascade);
