...
namespace ContosoUniversity.Models {
    public static class DbInitializer {
        public static void Initialize (SchoolContext context) {
            ...
            new Enrollment{StudentID=3,CourseID=2021,Grade=Grade.E},
            new Enrollment{StudentID=3,CourseID=1050,Grade=Grade.B},
            new Enrollment{StudentID=4,CourseID=1050,Grade=Grade.B},
            new Enrollment{StudentID=5,CourseID=4022,Grade=Grade.E},
            new Enrollment{StudentID=6,CourseID=4041,Grade=Grade.C},
